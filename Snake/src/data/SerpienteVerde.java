	...
	public void dibujoSnake(Graphics g) {
		...
		for (int n = 0; n < cuerpo.size() - 1; n++) {
			...
			if (contador == 1) {
				...
				g.drawImage(new ImageIcon(SerpienteVerde.class.getResource("../recursos/Head.png")).getImage(), 0,
						0, 20, 20, null);
			((Graphics2D) g).setTransform( new AffineTransform() );
				...
				((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
				g.drawImage(new ImageIcon(SerpienteVerde.class.getResource("../recursos/Cola.png")).getImage(), p1.x*0 ,
						p1.y*0, 20, 20, null);
				...
				((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
				g.drawImage(new ImageIcon(SerpienteVerde.class.getResource("../recursos/Cuerpo.png")).getImage(), p2.x*0,
						p2.y*0, 20, 20, null);
