...
public class Serpiente {
	...
	public Serpiente(int serpienteSeleccionada) {
		...
		if (selectedSnake == 0) {
			for (int n = 0; n < cuerpo.size() - 1; n++) {
				...
				if (contador == 1) {
					...
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/Head.png")).getImage(), 0, 0, 20, 20, null);
					...
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/Cola.png")).getImage(), p1.x*0, p1.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform());
					Point p2 = cuerpo.get(n);
					((Graphics2D) g).translate( p2.x * 20, p2.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/Cuerpo.png")).getImage(), p2.x*0, p2.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform() );
				}
			}
		} else if (selectedSnake == 1){
			for (int n = 0; n < cuerpo.size() - 1; n++) {
				contador++;
				if (contador == 1) {
					Point p = cuerpo.get(0);
					...
					int difAncho = (20 - p.x * 20) / 2;
					int difAlto = (20 - p.y * 20) / 2;
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/CabezaRoja.png")).getImage(), 0, 0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform());
				} else {
					int last = cuerpo.size() - 1;
					Point p1 = cuerpo.get(last);
					((Graphics2D) g).translate( p1.x * 20, p1.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/ColaRoja.png")).getImage(), p1.x*0, p1.y*0, 20, 20, null);
					...
					((Graphics2D) g).translate( p2.x * 20, p2.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/CuerpoRojo.png")).getImage(), p2.x*0, p2.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform() );
				
				}	
			}
		} else if (selectedSnake == 2) { //CAMBIAR SERPIENTE A AZUL
			for (int n = 0; n < cuerpo.size() - 1; n++) {
				contador++;
				if (contador == 1) {
					Point p = cuerpo.get(0);
					...
					int difAncho = (20 - p.x * 20) / 2;
					int difAlto = (20 - p.y * 20) / 2;				
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/HeadAzul.png")).getImage(), 0, 0, 20, 20, null);
				((Graphics2D) g).setTransform( new AffineTransform() );
				} else {
					int last = cuerpo.size() - 1;
					Point p1 = cuerpo.get(last);
					((Graphics2D) g).translate( p1.x * 20, p1.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/ColaAzul.png")).getImage(), p1.x*0, p1.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform());
					Point p2 = cuerpo.get(n);
					((Graphics2D) g).translate( p2.x * 20, p2.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/CuerpoAzul.png")).getImage(), p2.x*0, p2.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform() );
				}
			}
		} else if (selectedSnake == 3) { //CAMBIAR SERPIENTE A MORADA
			for (int n = 0; n < cuerpo.size() - 1; n++) {
				contador++;
				if (contador == 1) {
					Point p = cuerpo.get(0);
					...
					int difAncho = (20 - p.x * 20) / 2;
					int difAlto = (20 - p.y * 20) / 2;
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/HeadRosa.png")).getImage(), 0, 0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform());
				} else {
					int last = cuerpo.size() - 1;
					Point p1 = cuerpo.get(last);
					((Graphics2D) g).translate( p1.x * 20, p1.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/ColaRosa.png")).getImage(), p1.x*0, p1.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform());
					Point p2 = cuerpo.get(n);
					((Graphics2D) g).translate( p2.x * 20, p2.y * 20 );
					((Graphics2D) g).rotate(angulo(), 20/2, 20/2 );
					g.drawImage(new ImageIcon(Serpiente.class.getResource("../recursos/CuerpoRosa.png")).getImage(), p2.x*0, p2.y*0, 20, 20, null);
					((Graphics2D) g).setTransform( new AffineTransform() );
				}	
			}
		}
